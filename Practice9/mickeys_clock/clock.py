...
def draw_hand(surface, angle, length, color, width, center):
...
def draw_clock(surface, width, height):
    ...
    draw_hand(surface, hour_angle, 120, (0, 0, 0), 8, center)
    draw_hand(surface, minute_angle, 180, (0, 0, 0), 5, center)
    draw_hand(surface, second_angle, 200, (255, 0, 0), 2, center)